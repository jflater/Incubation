...
```{r, warning=F}
GetAlienHeatMap <- function(physeq, control_otus, alien_otus, recieving_otus){
...
```{r, warning=FALSE}
alf.heatmap <- GetAlienHeatMap(incubation.physeq, Control.otus, AlfalfaAmend.otus, Alfalfa.otus)
alf.heatmap
