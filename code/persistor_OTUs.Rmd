...
Do we identify aliens by comparing to control and opposite amended samples? I.E. amendment OTUs vs (Control + Compost OTUs)?
...
GetAlienHeatMap <- function(control_otus, alien_otus, recieving_otus){
  ...
  # control_otus <- unique(c(Control.otus, Compost.otus))
  # alien_otus <- AlfalfaAmend.otus
  # recieving_otus <- Alfalfa.otus
  # 
