...
p <- final_resp  + 
  geom_hilight(node = 232, fill = "gray", alpha=0.4, extend = 3.45) + 
  geom_hilight(node = 201, fill = "gray", alpha=0.4, extend = 3.5) + 
  geom_hilight(node = 212, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 183, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 186, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 193, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 158, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 132, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 124, fill = "gray", alpha=0.4, extend = 1) + 
  geom_hilight(node = 126, fill = "gray", alpha=0.4, extend = 1) 

pp <- p %<+% new.labels +
  geom_nodelab(aes(label=new.label), size=3, color="red", alpha = 1, nudge_x =- .1)
...
t <- pp + 
  geom_hilight(node = 4, fill = "green", alpha=0.4) + 
  geom_hilight(node = 24, fill = "green", alpha=0.4) + 
  geom_hilight(node = 32, fill = "green", alpha=0.4) + 
  geom_hilight(node = 62, fill = "brown", alpha=0.4) + 
  geom_hilight(node = 64, fill = "brown", alpha=0.4) + 
  geom_hilight(node = 65, fill = "brown", alpha=0.4)
ggsave("../Figures/resp_tree_walienshilighted.tiff", plot = t, device = "tiff", width = 19, height = 32, units = "cm", dpi = 500)
t
```
