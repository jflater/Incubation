...
p <- final_resp  + 
  ...
  geom_hilight(node = 201, fill = "gray", alpha=0.4, extend = 3.59) + 
  geom_hilight(node = 212, fill = "gray", alpha=0.4, extend = 3.985) + 
  geom_hilight(node = 183, fill = "gray", alpha=0.4, extend = 3.76) + 
  geom_hilight(node = 186, fill = "gray", alpha=0.4, extend = 3.77) + 
  geom_hilight(node = 193, fill = "gray", alpha=0.4, extend = 3.817) + 
  geom_hilight(node = 158, fill = "gray", alpha=0.4, extend = 3.86) + 
  geom_hilight(node = 132, fill = "gray", alpha=0.4, extend = 4.09) + 
  geom_hilight(node = 124, fill = "gray", alpha=0.4, extend = 4.06) + 
  geom_hilight(node = 126, fill = "gray", alpha=0.4, extend = 4.04) + 
