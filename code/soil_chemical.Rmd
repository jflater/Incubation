...
p
ggsave("../Figures/Figure_3.tiff", plot = p + theme_my() +
  theme(legend.position = "none"), device = "tiff", width = 190, height = 90, units = "mm", dpi = 500)
```
...
p <- day_ggboxplot(data) +
  ...
  theme(legend.position = "none")
p
ggsave("../Figures/Figure_4.tiff", plot = p + theme_my() +
  theme(legend.position = "none"), device = "tiff", width = 190, height = 90, units = "mm", dpi = 500)
```
