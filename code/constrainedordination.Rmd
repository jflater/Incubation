...
ggsave("../Figures/Constrained.png", plot = plot, device = "png", width = 180, height = 90, units = "mm", dpi = 500)
```
```{r}
...
b
b$Variable <- c("Day", "Treatment", "Nitrate", "C:N", "TOC", "Others", "Unexplained")
b
library("janitor")
